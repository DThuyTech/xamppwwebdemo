(function($) {
    ...
    $(document).on('click', '.ultp-dash-faq-icon', function(e) {
        const pop = $(this).parent().find('.dash-faq-container');
    ...
    $(document).on("click", function(event){
        if(!$(event.target).closest(".dash-faq-container").length){
            const popUp = $(document).find('.dash-faq-container');
            if(popUp && !event.target.classList.contains('ultp-dash-faq-icon')) {
