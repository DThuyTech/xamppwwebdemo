...
<div class="ifs-modal">
    <div class="ifs-dialog">
        <div class="ifs-header">
            <div class="ifs-title"><?php esc_html_e("Folder Type", 'ifolders'); ?></div>
        ...
        <div class="ifs-data">
            ...
            <div al-if="Modal.data.groups.loaded">
                <input class="ifs-text" al-attr.class.ifs-readonly="Modal.data.predefined" al-value="Modal.data.title" placeholder="<?php esc_html_e("Title", 'ifolders'); ?>">
                <label>
                    <input type="checkbox" al-checked="Modal.data.enabled">
                    <?php esc_html_e("Enabled", 'ifolders'); ?>
                </label>
                <div al-if="!Modal.data.predefined">
                    <p><?php esc_html_e("To enable the folder manager for a custom post type, enter its identifier below.", 'ifolders'); ?></p>
                    <div class="ifs-input-group">
                        <input class="ifs-input ifs-long" type="text" al-value="Modal.data.type" placeholder="<?php esc_html_e("Custom Post Type", 'ifolders'); ?>">
                        <div class="ifs-button ifs-select" al-on.click="App.fn.posttypes.select(Modal.fn.changeType)">
                            <?php esc_html_e("Select", 'ifolders'); ?>
                        </div>
                    </div>
                </div>
                <p><?php esc_html_e("Add or delete a group for access to this folder type", 'ifolders'); ?></p>
                <div class="ifs-table-toolbar ifs-green">
                    <div class="ifs-left-group">
                        <div class="ifs-btn" al-on.click="Modal.fn.groups.selectGroups(Modal.fn.groups.addGroups)" title="<?php esc_html_e("Add groups", 'ifolders'); ?>">
                        ...
                        <div class="ifs-btn" al-if="Modal.data.groups.checked" al-on.click="Modal.fn.groups.delete()" title="<?php esc_html_e("Delete selected groups", 'ifolders'); ?>">
