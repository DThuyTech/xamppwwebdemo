...
<div id="ifs-form-create" class="ifs-form">
    ...
    <div class="ifs-data">
        <div class="ifs-row">
            <input id="ifs-folder-name" class="ifs-text" type="text" placeholder="Folder 1, Folder 2, etc." value="" autocomplete="off">
...
<div id="ifs-form-copy" class="ifs-form">
    <div class="ifs-header">
        <div class="ifs-title"><?php esc_html_e('Duplicate Folder', 'ifolders'); ?></div>
        <div class="ifs-close">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path d=" M 7.734 6.281 L 6.328 7.688 L 10.609 11.969 L 6.266 16.313 L 7.672 17.719 L 12.016 13.375 L 16.328 17.688 L 17.734 16.281 L 13.422 11.969 L 17.672 7.719 L 16.266 6.313 L 12.016 10.563 L 7.734 6.281 Z " />
            </svg>
    ...
    <div class="ifs-data">
        <div class="ifs-row">
            <div class="ifs-info">
            <p><?php esc_html_e('Are you sure you want to duplicate the selected folder and all subfolders?', 'ifolders'); ?>
            <p><?php esc_html_e('Note: all items inside those folders will not be copied to a new destination.', 'ifolders'); ?></p>
            </div>
        </div>
        <div class="ifs-row">
            <div>
                <p><?php esc_html_e('Source folder', 'ifolders'); ?></p>
                <select id="ifs-folder-source" class="ifs-select"></select>
            </div>
        </div>
        <div class="ifs-row">
            <div>
            <p><?php esc_html_e('Destination folder', 'ifolders'); ?></p>
            <select id="ifs-folder-destination" class="ifs-select"></select>
            </div>
        </div>
    </div>
    <div class="ifs-footer">
        <div class="ifs-btn ifs-close"><?php esc_html_e('Cancel', 'ifolders'); ?></div>
        <div class="ifs-btn ifs-submit"><?php esc_html_e('Submit', 'ifolders'); ?></div>
    </div>
</div>
...
<div class="ifs-panel">
    ...
    <div id="ifs-search" class="ifs-search">
        <input id="ifs-search-input" class="ifs-search-input" placeholder="<?php esc_html_e('Enter folder name...', 'ifolders'); ?>" type="text" autocomplete="off">
        <div class="ifs-search-icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path d=" M 18.341 16.876 L 22.138 20.69 L 20.676 22.041 L 20.676 22.041 L 16.941 18.29 C 15.58 19.361 13.864 20 12 20 C 7.585 20 4 16.415 4 12 L 4 12 C 4 7.585 7.585 4 12 4 C 16.415 4 20 7.585 20 12 C 20 13.835 19.381 15.526 18.341 16.876 Z  M 6 12 C 6 8.689 8.689 6 12 6 C 15.311 6 18 8.689 18 12 C 18 15.311 15.311 18 12 18 C 8.689 18 6 15.311 6 12 L 6 12 Z " fill-rule="evenodd"/>
            </svg>
        </div>
        <div id="ifs-search-clear" class="ifs-search-clear">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path d=" M 7.734 6.281 L 6.328 7.688 L 10.609 11.969 L 6.266 16.313 L 7.672 17.719 L 12.016 13.375 L 16.328 17.688 L 17.734 16.281 L 13.422 11.969 L 17.672 7.719 L 16.266 6.313 L 12.016 10.563 L 7.734 6.281 Z "></path>
            </svg>
        </div>
    </div>
